...
func (dah deleteOneAddressHandler) Handle(ctx context.Context, cmd deleteOneAddress) custom_error.ContextError {
	return dah.repo.DeleteAddress(ctx, cmd.userUuid, cmd.street)
}
