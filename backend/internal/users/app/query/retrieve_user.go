...
func (rh retrieveUserHandler) Handle(ctx context.Context, retrieveUser retrieveUser) (user.User, custom_error.ContextError) {
	return rh.repo.GetByUuid(ctx, retrieveUser.uuid)
}
